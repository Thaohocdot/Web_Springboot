...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/admin/**").hasAnyRole("STAF","DIRE")// chỉ 2 thằng này được vvaof admin
                .antMatchers("/rest/authorities").hasRole("DIRE") // ngược lại
                .anyRequest().permitAll(); // còn lại ai cũng đc vào
        http.formLogin()
